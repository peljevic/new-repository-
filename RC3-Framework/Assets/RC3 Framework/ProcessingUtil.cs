...
namespace RC3.Graphs
{
    public class ProcessingUtil
    {
        ...
        /// <returns></returns>
        public void RemapGraphDepths(IGraph graph, int[] inputvalues, float minoutvalue, float maxoutvalue, 
                                  out float[] outputvalues, out List<int> unreachablevertices, out List<int> edgelessvertices)
        {
        ...
        // Private Methods - (Undirected Graph) - Counting Closures 
        /// <summary>
        ...
        #region Directed Graph Analysis
        ...
        #endregion Directed Graph Analysis
